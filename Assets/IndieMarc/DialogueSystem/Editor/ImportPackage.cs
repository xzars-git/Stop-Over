...
namespace IndieMarc.DialogueSystem
{
    ...
    public class ImportPackage
    {
        ...
        {
            if (!completed && DoesAssetExists("Assets/IndieMarc/DialogueSystem/Prefabs/CharacterTopDown.prefab")){
                completed = true;
                marked_for_save = false;

                CreateSortingLayer("Perspective");
                CreateSortingLayer("Top");
                SetPrefabLayer("Assets/IndieMarc/DialogueSystem/Prefabs/CharacterTopDown.prefab", "Perspective");
                SetPrefabLayer("Assets/IndieMarc/DialogueSystem/Prefabs/NPCTopDown.prefab", "Perspective");
                SetPrefabLayer("Assets/IndieMarc/DialogueSystem/Prefabs/TalkBubble.prefab", "Top");
                SetPrefabLayer("Assets/IndieMarc/DialogueSystem/Prefabs/TalkBubbleAngle.prefab", "Top");
